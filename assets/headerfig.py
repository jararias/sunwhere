...
fuentes = ("Microsoft Sans Serif",)
textcolor, background = ("black", "transparent")
textcolor, background = ("white", "transparent")
# textcolor, background = ("black", "white")
# textcolor, background = ("white", "#131416")
...
for i, fuente in enumerate(fuentes):
    ...
    ax.text(0.5, 0.35, 'sunwhere', ha='center', va='center',
            ...
            family=fuente, weight='medium', color=textcolor)
    ...
    filename = (f'headerfig_{fuente.replace(" ", "_")}_'
                f'{textcolor.replace("#", "")}_on_'
                f'{background.replace("#", "")}.png')
    pl.savefig(out_dir / filename, transparent=background=="transparent")
    pl.cla()
